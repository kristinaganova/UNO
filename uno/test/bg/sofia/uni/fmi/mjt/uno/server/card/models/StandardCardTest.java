...
class StandardCardTest {
    ...
    void testIsPlayableWithSameColorActionCard() {
        ActionCard actionCard = new ActionCard(Color.RED, ActionCardType.SKIP, effectStrategy);
    ...
    void testIsNotPlayableWithDifferentColorActionCard() {
        ActionCard actionCard = new ActionCard(Color.BLUE, ActionCardType.SKIP, effectStrategy);
