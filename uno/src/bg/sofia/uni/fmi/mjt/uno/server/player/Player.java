...
public class Player {
    ...
    public void sendMessage(String message) {
        if (client == null || !client.isOpen()) {
            System.err.println("[Player] Cannot send message to " + account.username() + " (Client disconnected)");
            return;
        }
        ...
        try {
            ...
            client.write(buffer);
            System.out.println("[Player] Sent message to " + account.username() + ": " + message);
        } catch (IOException e) {
            System.err.println("Error sending message to player " + account.username() + ": " + e.getMessage());
        }
    }
